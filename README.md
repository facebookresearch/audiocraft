...
3. Finally, a demo is also available on the [`facebook/MusicGen`  HugginFace Space](https://huggingface.co/spaces/facebook/MusicGen) (huge thanks to all the HF team for their support).
