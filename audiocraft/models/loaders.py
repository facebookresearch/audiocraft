...
def _get_state_dict(file_or_url_or_id: tp.Union[Path, str], filename: tp.Optional[str] = None, device='cpu', cache_dir: tp.Optional[str] = None):
    ...
    if os.path.isfile(file_or_url_or_id):
        ...
        file = hf_hub_download(repo_id=HF_MODEL_CHECKPOINTS_MAP[file_or_url_or_id], filename=filename, cache_dir=cache_dir)
